...
CREATE TABLE IF NOT EXISTS `suppingmall`.`user` (
  `user_id` BIGINT(20) NOT NULL COMMENT '유저번호',
...
CREATE TABLE IF NOT EXISTS `suppingmall`.`product` (
  ...
  `manuplate_date` TIMESTAMP(3) NULL COMMENT '제조일자',
  `contry_of_origin` VARCHAR(45) NULL COMMENT '원산지',
...
CREATE TABLE IF NOT EXISTS `suppingmall`.`basket` (
  `basket_id` BIGINT(20) NOT NULL COMMENT '장바구니번호',
  `product_id` BIGINT(20) NOT NULL COMMENT '물품번호',
...
CREATE TABLE IF NOT EXISTS `suppingmall`.`payment` (
  `payment_id` BIGINT(20) NOT NULL COMMENT '결제번호',
  `order_id` BIGINT(20) NOT NULL COMMENT '주문번호',
  ...
  `cancle_date` TIMESTAMP(3) NULL DEFAULT NULL COMMENT '결제취소일',
