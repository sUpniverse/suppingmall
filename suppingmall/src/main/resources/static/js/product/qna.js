...
function setReplyList(list){
    ...
    list.forEach(function (qna) {
        str += '<ul class="tableRow">\n' +
            '       <li class="body">\n' +
            '           <div class="cell replyYn">'+isReplyExist(qna)+'</div>\n' +
            '           <div class="cell qnaTitle">\n' +
            '                 <a role="button" data-toggle="collapse" href="#qna-'+qna.qnaId+'" aria-expanded="false">'+qna.title+'</a>\n' +
            '           </div>\n' +
            '           <div class="cell creator">'+qna.creator.nickName+'</div>\n' +
            '           <div class="cell createdDate">'+convertLocalDateTime(qna.createdDate)+'</div>\n' +
            '         </li>\n' +
        ...
        if(qna.reply !== null) {
            str += '        <div class="row border-top p-3">\n' +
                ...
                '             <div class="cell createdDate">'+convertLocalDateTime(qna.reply.createdDate)+'</div>\n' +
                '           </div>';
